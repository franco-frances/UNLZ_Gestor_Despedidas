...
namespace GestorEventos.Api.Controllers
{
	...
	public class ServiciosController : ControllerBase
	{
		...
		public IActionResult PutModificarServicio(int idServicio, [FromBody] ServiciosVM servicioModificado)
		{
			ServiciosService serviciosService= new ServiciosService();
			serviciosService.modificarServicio(idServicio, servicioModificado);
